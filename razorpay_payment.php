...
<meta name="keywords" content="Trading Company" />
<style>
.appHeader1 {
...
$data = [ 
		...
		curl_setopt($ch, CURLOPT_USERPWD, "rzp_test_OMdtvhZungbjX0:TDSC3N58h1EazYbfh76lVpB3"); // Input your Razorpay Key Id and Secret Id here
...
<div class="acd-items acd-arrow text-center">
        ...
        <h5 class=" thanks-title2 mt-1">You Paid <strong>₹ <?php echo number_format($amt,2);?></strong> to Trading Company.</h5>
