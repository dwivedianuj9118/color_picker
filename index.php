...
<!-- * Page loading --> 
<a href="http://crown17.in/apk/crown17.apk">
 
<div class="appHeader1 height">
  <div class="text-center"> 
    <div class="pageTitle"><i class="icon ion-ios-download"></i> Download App</div>
  </div>
...
<!-- App Header -->
<div class="appHeader">
  <div class="pageTitle"  > <h1 style="color:Red; font-size: 26px; font-family: arial;"> Welcome Back</h1></div>
</div>
