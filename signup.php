  ...
  <div class="appContent1 mb-2">
    ...
    <div class="row ">
      ...
      <i class="icon ion-ios-gift"></i>
        <input type="text" name="rcode" id="rcode" class="form-control" placeholder="Recommendation Code" value="<?php echo @$_GET['code']?'100000':'100000';?>">
      </div>
    ...
    <div class="modal-content ">
      <div class="modal-body">
        <div class="text-center">
          <h5>Thank you !</h5>
          <h6>Your account Registration Sucessful....</h6>
          <div class="text-center">
