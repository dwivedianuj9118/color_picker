  ...
  <div class="appContent3 text-white">
    <div class="row">
      <div class="col-12 mb-1">
        ...
        Email:  <?php echo user($con,'email',$userid);?>
       
        </div>
        <div class="col-12 mb-1"></div>
      <div class="col-12 mb-1">Available balance: ₹ <?php echo number_format(wallet($con,'amount',$userid), 2);?></div>
     <div class="col-12">
     <a href="recharge.php" class="btn btn-sm btn-success pull-left m-1">Recharge</a>
     <a href="withdrawal.php" class="btn btn-sm btn-success pull-left m-1">Withdrawal</a> 
...
<div class="card-header">
            <h2 class="mb-0"> 
             <a href="https://Wa.me/919174212385" class="btn btn-link collapsed"><i class="fa fa-whatsapp text-primary" style="font-size:16px"></i>
           Join Whatsapp </a> </h2>
          </div>
